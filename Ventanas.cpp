...
Frame0::Frame0( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, wxT("Este es un ejemplo de integracion entre wxFormsBuilder y ZinjaI"), wxDefaultPosition, wxSize( -1,-1 ), wxST_NO_AUTORESIZE|wxALIGN_CENTER_HORIZONTAL );
